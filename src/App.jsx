    ...
    try {
      ...
      if (finalContent) {
        updateMessage(conversationId, placeholder.id, () => ({
          ...
          status: 'done',
          metadata: response?.reasoning
            ? { reasoning: response.reasoning, raw: response.raw }
            : { raw: response?.raw }
        }))
      } else {
    ...
    <div className="app-container">
      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-footer">
          <Button
            ...
            disabled={!isTyping}
            title={translate('tooltips.stopGenerating')}
            aria-label={translate('tooltips.stopGenerating')}
          >
            ...
            <div className="chat-actions">
              <div className="model-pill">
                {translate(
                  ...
                  PROVIDERS[modelConfig.provider]?.label ?? modelConfig.provider
                )}{' '}
                路 {modelConfig.model}
              </div>
              <Button
          ...
          {Array.isArray(message.attachments) && message.attachments.length > 0 && (
            <div className="message-attachments">
              {message.attachments.map(attachment => (
                <div key={attachment.id ?? `${attachment.name}-${attachment.size}-${attachment.type}`} className="attachment-item">
        ...
        >
          ...
          <div className="input-container">
            ...
            <Button
              ...
              disabled={(inputMessage.trim().length === 0 && pendingAttachments.length === 0) || isTyping}
            >
      ...
      <aside className={`config-panel ${showConfig ? 'open' : ''}`}>
        ...
        <div className="config-content">
          ...
          <div className="config-section">
            <label className="config-label">{translate('labels.temperature')}</label>
            <input
