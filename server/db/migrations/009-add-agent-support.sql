...
('agent-research-assistant', 1, '研究助手', '专业的学术研究助手，擅长文献调研、数据分析和报告撰写', 'https://example.com/avatar/research.png', '你是一个专业的学术研究助手。请帮助用户进行文献调研、数据分析、报告撰写等研究工作。', '["research", "analysis", "writing", "data_processing"]', '["web_search", "ai_analysis", "data_transform", "write_file"]', '{"maxConcurrentTasks": 3, "stopOnError": false, "retryAttempts": 2}', 'inactive'),
('agent-data-analyst', 1, '数据分析师', '专业的数据分析师，擅长数据处理、统计分析和可视化', 'https://example.com/avatar/analyst.png', '你是一个专业的数据分析师。请帮助用户进行数据处理、统计分析、图表制作等工作。', '["data_analysis", "statistics", "visualization", "reporting"]', '["read_file", "data_transform", "ai_analysis", "write_file"]', '{"maxConcurrentTasks": 2, "stopOnError": true, "retryAttempts": 3}', 'inactive'),
('agent-content-creator', 1, '内容创作者', '专业的内容创作者，擅长文案写作、创意策划和内容优化', 'https://example.com/avatar/creator.png', '你是一个专业的内容创作者。请帮助用户进行文案写作、创意策划、内容优化等工作。', '["writing", "creativity", "marketing", "seo"]', '["ai_analysis", "web_search", "write_file", "validate_data"]', '{"maxConcurrentTasks": 4, "stopOnError": false, "retryAttempts": 1}', 'inactive');
